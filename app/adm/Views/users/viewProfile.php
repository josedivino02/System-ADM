...
<div class="container-fluid">
    <div class="row">
      <div class="col-12">
        <div class="mb-2">
          <h3 class="text-color-branco">Meu Perfil</h3>
  ...
  <div class="justify-content-center">
    <section class="card mb-4 centralizar" >
      <div class="card grid mt-3 text-center largura-50">
        <h3 class="text-color-black grid">Perfil: <span class="nome_usuario" style="background-color: #6C5B7B;">[NOME DO USUÁRIO]</span></h3>
        <hr class="mb-1 line-grey">
        ...
        <div class="card-body grid dados-usuarios">
          <form action="" method="POST" id="form-edit-user">
            <div class="grid">
              ...
              <hr class="mb-1 line-grey">
              <div class="grid mt-3">
                <span class="grid" id="text-msg"><div class='alert alert-warning col-4 centered mb-2'>Carregando...</div></span>
                <img id="imagem-user" class="img-modal" src="http://localhost/estrutura_adm_mvc/app/adm/assets/img/gato.jpg" style="width: 50%; height: 50%;" alt="Carregando...">
              </div>
              <hr class="mb-1 line-grey">
            </div>
          </form>
...
//=------------------------------------------------------------------------------------------------------------
  ...
  {
      var user_id = <?php echo $_SESSION['usuario_id']; ?>;
...
//=------------------------------------------------------------------------------------------------------------
   ...
   function preencherDadosUsuarios(dados_usuarios, situacoes)
   {
    ...
    let html = `
      <form action="" method="POST" id="form-my-edit-user">
        <div class="grid">
            ...
            <div class="grid">
              <a href="<?php echo URLADM?>users/edit-my-user-img" class="btn btn-info col-2" style="margin-left: 45rem!important;" role="button" aria-pressed="true">Editar Imagem</a>
            </div>
            <hr class="mb-1 line-grey">
            <div class="grid mt-3">
            ...
            <hr class="mb-1 line-grey">
            <button class="form-group col-4 button-success mb-3" type="button" name="SendEditUser" id="SendEditUser" value="Atualizar" onclick='updateDataUser(${input_id})'>Atualizar</button>
        </div>
      </form>
      `;
    ...
    if (input_img !== null) {
      imagem.src = `http://localhost/estrutura_adm_mvc/app/adm/assets/img/users/${input_id}/${input_img}`;
...
//=------------------------------------------------------------------------------------------------------------
  async function updateDataUser(input_id)
  {
    ...
    const response = await axios.post('update-my-user-data', data);
    reload()
  }
